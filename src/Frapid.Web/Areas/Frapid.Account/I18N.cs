...
namespace Frapid.Account
{
	...
	public static class I18N
	{
		...
		/// <summary>
		///To reset your password, enter the email address which is registered on our website. We will send you an email with instructions to help you reset your password.
		/// </summary>
		...
		/// <summary>
		///<p>We have sent reset instructions to your email address. Please follow the link on that email to reset your account.</p>
		/// </summary>
		...
		/// <summary>
		///To reset your password, enter the email address which is registered i=on our website. We will send you an email with instructions to help you reset your password.
		/// </summary>
